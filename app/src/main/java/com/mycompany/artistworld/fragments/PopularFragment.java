...
public class PopularFragment extends Fragment implements IdeasRecyclerAdapter.ListItemClickListener{
    ...
    private List<Project> mPopularIdeas;
    ...
    public static PopularFragment newInstance(String title) {
        PopularFragment fragmentPopular = new PopularFragment();
        Bundle args = new Bundle();
        args.putString("titleParam", title);
        fragmentPopular.setArguments(args);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mPopularIdeas = savedInstanceState.getParcelableArrayList(POPULAR_LIST);
            mIdeasRecyclerAdapter.setIdeasData(mPopularIdeas);
        } else {
            if (mPopularIdeas != null) {
    ...
    private void loadData() {
        ...
        Call<ProjectResponse> call = ideaService.discoverIdeas("True", "-popular", 1, "support");
        call.enqueue(new Callback<ProjectResponse>() {
            @Override
            public void onResponse(Call<ProjectResponse> call, Response<ProjectResponse> response) {
                mLoadingIndicator.setVisibility(View.INVISIBLE);
                if (response.isSuccessful()){
                    mPopularIdeas = response.body().getmResults();
                    showIdeaDataView();
                    mIdeasRecyclerAdapter.setIdeasData(mPopularIdeas);
                } else {
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putParcelableArrayList(POPULAR_LIST, (ArrayList<Project>) mPopularIdeas);
    }
